...
function user_exists($string, $array){
	$i = 1;
	$string_new = $string;
	if(in_array($string_new, array('follow', 'discover', 'register', 'login', 'admin', 'pierre', 'stoffe', 'giftt', 'you', 'your', 'me', 'five', 'a', 'default', 'reset', 'add', 'edit', 'extension', 'remove', 'deactivate'))){
		$string_new = $string . $i++;
	}
