		...
		<section class="content container-fluid">
			...
			<aside class="col-sm-3">
				...
				<div class="pod actions">
					...
					<div class="cont">
						<?php if($mine){ ?>
						<p class="edit"><a class="icon_cont" href="/<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>/edit"><span class="icon icon-edit"></span>Edit wish</a></p>
						<p class="remove"><a class="icon_cont" href="/<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>/remove"><span class="icon icon-close"></span>Remove wish</a></p>
						<?php }else{ ?>
